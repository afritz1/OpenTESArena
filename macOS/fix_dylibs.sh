...
codesign -s - -o linker-signed ${TES_APP_BUNDLE_PATH}/Contents/Frameworks/libvulkan.dylib
...
codesign -s - -o linker-signed ${TES_APP_BUNDLE_PATH}/Contents/Frameworks/libMoltenVK.dylib
