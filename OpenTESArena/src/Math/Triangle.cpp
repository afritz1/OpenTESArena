...
Triangle::Triangle(const Float3d &p1, const Float3d &p2, const Float3d &p3,
...
const Float3d &Triangle::getP1() const
{
	return this->p1;
}

const Float3d &Triangle::getP2() const
{
	return this->p2;
}

const Float3d &Triangle::getP3() const
{
	return this->p3;
}

const Float2d &Triangle::getUV1() const
{
	return this->uv1;
}

const Float2d &Triangle::getUV2() const
{
	return this->uv2;
}

const Float2d &Triangle::getUV3() const
{
	return this->uv3;
}

Float3d Triangle::getNormal() const
{
...
Float3d Triangle::getTangent() const
{
	// Not so simple. Needs texture coordinates to work for any orientation (like
	// with cube faces).

	// From:
	// http://gamedev.stackexchange.com/questions/68612/how-to-compute-tangent-and-bitangent-Floats
...
Float3d Triangle::getBitangent() const
{
	// From:
	// http://gamedev.stackexchange.com/questions/68612/how-to-compute-tangent-and-bitangent-Floats
	// Also look at http://stackoverflow.com/questions/5255806/how-to-calculate-tangent-and-binormal.
