	...
	void ProcessMeshesForRasterizationInternal(int meshCount, const Matrix4d &viewMatrix, const Matrix4d &projectionMatrix)
	{
		for (int meshIndex = 0; meshIndex < meshCount; meshIndex++)
		{
			...
			for (int triangleIndex = 0; triangleIndex < triangleCount; triangleIndex++)
			{
				...
				meshProcessCache.shadedV0s[triangleIndex] = shadedV0;
				meshProcessCache.shadedV1s[triangleIndex] = shadedV1;
				meshProcessCache.shadedV2s[triangleIndex] = shadedV2;
				...
				meshProcessCache.uv0s[triangleIndex] = uv0;
				meshProcessCache.uv1s[triangleIndex] = uv1;
				meshProcessCache.uv2s[triangleIndex] = uv2;
			}
