...
namespace PlayerConstants
{
	...
	constexpr double CLAMPED_MOVE_SPEED_PERCENT = 0.3; // Hack, this is less than max speed to retain snappiness of acceleration at 0 velocity
...
struct Player
{
	...
	bool isHealthCriticallyLow() const;
