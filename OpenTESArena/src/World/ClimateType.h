#ifndef CLIMATE_TYPE_H
#define CLIMATE_TYPE_H

// A climate is set for each location. It is not dependent on the province, and 
// may or may not have a dependence on geographical location, since deserts seem 
// to be scattered around; not just in Hammerfell.
