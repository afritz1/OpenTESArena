...
private:
	...
	void readFLOR(const uint8_t *flor, const INFFile &inf, int florWidth, int florDepth,
	...
	void readMAP1(const uint8_t *map1, const INFFile &inf, int map1Width, int map1Depth,
		int gridWidth, int gridDepth, int xOffset, int zOffset);
	void readMAP1(const uint8_t *map1, const INFFile &inf, int gridWidth, int gridDepth);
	void readMAP2(const uint8_t *map2, const INFFile &inf, int map2Width, int map2Depth,
		int gridWidth, int gridDepth, int xOffset, int zOffset);
