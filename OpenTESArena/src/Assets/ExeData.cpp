...
bool ExeDataEntities::init(Span<const std::byte> exeBytes, const KeyValueFile &keyValueFile)
{
	...
	const int guardArmorIDsOffset = GetExeAddress(*section, "GuardArmorIDs");
	...
	initInt8Array(this->guardArmorIDs, exeBytes, guardArmorIDsOffset);
...
bool ExeDataServices::init(Span<const std::byte> exeBytes, const KeyValueFile &keyValueFile)
{
	...
	const int equipmentModalSellOffset = GetExeAddress(*section, "EquipmentModalSell");
	const int equipmentModalRepairOffset = GetExeAddress(*section, "EquipmentModalRepair");
	const int equipmentModalStealOffset = GetExeAddress(*section, "EquipmentModalSteal");
	const int equipmentModalExitOffset = GetExeAddress(*section, "EquipmentModalExit");
	const int equipmentBuyModalTitleOffset = GetExeAddress(*section, "EquipmentBuyModalTitle");
	const int equipmentBuyModalWeaponsOffset = GetExeAddress(*section, "EquipmentBuyModalWeapons");
	const int equipmentBuyModalArmorOffset = GetExeAddress(*section, "EquipmentBuyModalArmor");
	const int equipmentStealSuccessOffset = GetExeAddress(*section, "EquipmentStealSuccess");
	const int equipmentItemEquippedWhenSellingOffset = GetExeAddress(*section, "EquipmentItemEquippedWhenSelling");
	const int equipmentItemEquippedWhenSellingYesOffset = GetExeAddress(*section, "EquipmentItemEquippedWhenSellingYes");
	const int equipmentItemEquippedWhenSellingNoOffset = GetExeAddress(*section, "EquipmentItemEquippedWhenSellingNo");
	const int magesGuildModalTitleOffset = GetExeAddress(*section, "MagesGuildModalTitle");
	const int magesGuildModalBuyOffset = GetExeAddress(*section, "MagesGuildModalBuy");
	const int magesGuildModalDetectMagicOffset = GetExeAddress(*section, "MagesGuildModalDetectMagic");
	const int magesGuildModalSpellmakerOffset = GetExeAddress(*section, "MagesGuildModalSpellmaker");
	const int magesGuildModalStealOffset = GetExeAddress(*section, "MagesGuildModalSteal");
	const int magesGuildModalExitOffset = GetExeAddress(*section, "MagesGuildModalExit");
	const int magesGuildItemAlreadyIdentifiedOffset = GetExeAddress(*section, "MagesGuildItemAlreadyIdentified");
	const int magesGuildItemIdentifyCostOffset = GetExeAddress(*section, "MagesGuildItemIdentifyCost");
	const int magesGuildPickItemModalTitleOffset = GetExeAddress(*section, "MagesGuildPickItemModalTitle");
	const int magesGuildPickItemModalPotionsOffset = GetExeAddress(*section, "MagesGuildPickItemModalPotions");
	const int magesGuildPickItemModalMagicItemsOffset = GetExeAddress(*section, "MagesGuildPickItemModalMagicItems");
	const int magesGuildPickItemModalSpellsOffset = GetExeAddress(*section, "MagesGuildPickItemModalSpells");
	const int tavernModalTitleOffset = GetExeAddress(*section, "TavernModalTitle");
	const int tavernModalBuyDrinksOffset = GetExeAddress(*section, "TavernModalBuyDrinks");
	const int tavernModalGetARoomOffset = GetExeAddress(*section, "TavernModalGetARoom");
	const int tavernModalSneakIntoARoomOffset = GetExeAddress(*section, "TavernModalSneakIntoARoom");
	...
	const int tavernRoomRentNumberOfDaysOffset = GetExeAddress(*section, "TavernRoomRentNumberOfDays");
	const int tavernRoomRentedOffset = GetExeAddress(*section, "TavernRoomRented");
	const int tavernRoomRentalCostOffset = GetExeAddress(*section, "TavernRoomRentalCost");
	const int tavernRoomRentedRemainingHoursOffset = GetExeAddress(*section, "TavernRoomRentedRemainingHours");
	const int tavernConsumeDrinkOffset = GetExeAddress(*section, "TavernConsumeDrink");
	const int tavernFreeRoomOffset = GetExeAddress(*section, "TavernFreeRoom");
	const int templeModalTitleOffset = GetExeAddress(*section, "TempleModalTitle");
	const int templeModalBlessOffset = GetExeAddress(*section, "TempleModalBless");
	const int templeModalCureOffset = GetExeAddress(*section, "TempleModalCure");
	const int templeModalHealOffset = GetExeAddress(*section, "TempleModalHeal");
	const int templeModalExitOffset = GetExeAddress(*section, "TempleModalExit");
	const int templeReceiveBlessingOffset = GetExeAddress(*section, "TempleReceiveBlessing");
	const int templeReceiveCuringOffset = GetExeAddress(*section, "TempleReceiveCuring");
	const int templeReceiveHealingOffset = GetExeAddress(*section, "TempleReceiveHealing");
	const int templePlayerIsFullHealthOffset = GetExeAddress(*section, "TemplePlayerIsFullHealth");
	const int templeDonationAmountOffset = GetExeAddress(*section, "TempleDonationAmount");
	const int templePlayerIsNotDiseasedOffset = GetExeAddress(*section, "TemplePlayerIsNotDiseased");
	const int templeServiceCostOffset = GetExeAddress(*section, "TempleServiceCost");
	const int citizenModalTitleOffset = GetExeAddress(*section, "CitizenModalTitle");
	const int citizenModalWhoAreYouOffset = GetExeAddress(*section, "CitizenModalWhoAreYou");
	const int citizenModalWhereIsOffset = GetExeAddress(*section, "CitizenModalWhereIs");
	const int citizenModalRumorsOffset = GetExeAddress(*section, "CitizenModalRumors");
	const int citizenModalExitOffset = GetExeAddress(*section, "CitizenModalExit");
	const int citizenRumorsModalTitleOffset = GetExeAddress(*section, "CitizenRumorsModalTitle");
	...
	this->equipmentModalSell = GetExeStringNullTerminated(exeBytes, equipmentModalSellOffset);
	this->equipmentModalRepair = GetExeStringNullTerminated(exeBytes, equipmentModalRepairOffset);
	this->equipmentModalSteal = GetExeStringNullTerminated(exeBytes, equipmentModalStealOffset);
	this->equipmentModalExit = GetExeStringNullTerminated(exeBytes, equipmentModalExitOffset);
	this->equipmentBuyModalTitle = GetExeStringNullTerminated(exeBytes, equipmentBuyModalTitleOffset);
	this->equipmentBuyModalWeapons = GetExeStringNullTerminated(exeBytes, equipmentBuyModalWeaponsOffset);
	this->equipmentBuyModalArmor = GetExeStringNullTerminated(exeBytes, equipmentBuyModalArmorOffset);
	this->equipmentStealSuccess = GetExeStringNullTerminated(exeBytes, equipmentStealSuccessOffset);
	this->equipmentItemEquippedWhenSelling = GetExeStringNullTerminated(exeBytes, equipmentItemEquippedWhenSellingOffset);
	this->equipmentItemEquippedWhenSellingYes = GetExeStringNullTerminated(exeBytes, equipmentItemEquippedWhenSellingYesOffset);
	this->equipmentItemEquippedWhenSellingNo = GetExeStringNullTerminated(exeBytes, equipmentItemEquippedWhenSellingNoOffset);
	this->magesGuildModalTitle = GetExeStringNullTerminated(exeBytes, magesGuildModalTitleOffset);
	this->magesGuildModalBuy = GetExeStringNullTerminated(exeBytes, magesGuildModalBuyOffset);
	this->magesGuildModalDetectMagic = GetExeStringNullTerminated(exeBytes, magesGuildModalDetectMagicOffset);
	this->magesGuildModalSpellmaker = GetExeStringNullTerminated(exeBytes, magesGuildModalSpellmakerOffset);
	this->magesGuildModalSteal = GetExeStringNullTerminated(exeBytes, magesGuildModalStealOffset);
	this->magesGuildModalExit = GetExeStringNullTerminated(exeBytes, magesGuildModalExitOffset);
	this->magesGuildItemAlreadyIdentified = GetExeStringNullTerminated(exeBytes, magesGuildItemAlreadyIdentifiedOffset);
	this->magesGuildItemIdentifyCost = GetExeStringNullTerminated(exeBytes, magesGuildItemIdentifyCostOffset);
	this->magesGuildPickItemModalTitle = GetExeStringNullTerminated(exeBytes, magesGuildPickItemModalTitleOffset);
	this->magesGuildPickItemModalPotions = GetExeStringNullTerminated(exeBytes, magesGuildPickItemModalPotionsOffset);
	this->magesGuildPickItemModalMagicItems = GetExeStringNullTerminated(exeBytes, magesGuildPickItemModalMagicItemsOffset);
	this->magesGuildPickItemModalSpells = GetExeStringNullTerminated(exeBytes, magesGuildPickItemModalSpellsOffset);
	this->tavernModalTitle = GetExeStringNullTerminated(exeBytes, tavernModalTitleOffset);
	this->tavernModalBuyDrinks = GetExeStringNullTerminated(exeBytes, tavernModalBuyDrinksOffset);
	this->tavernModalGetARoom = GetExeStringNullTerminated(exeBytes, tavernModalGetARoomOffset);
	this->tavernModalSneakIntoARoom = GetExeStringNullTerminated(exeBytes, tavernModalSneakIntoARoomOffset);
	...
	this->tavernRoomRentNumberOfDays = GetExeStringNullTerminated(exeBytes, tavernRoomRentNumberOfDaysOffset);
	this->tavernRoomRented = GetExeStringNullTerminated(exeBytes, tavernRoomRentedOffset);
	this->tavernRoomRentalCost = GetExeStringNullTerminated(exeBytes, tavernRoomRentalCostOffset);
	this->tavernRoomRentedRemainingHours = GetExeStringNullTerminated(exeBytes, tavernRoomRentedRemainingHoursOffset);
	this->tavernConsumeDrink = GetExeStringNullTerminated(exeBytes, tavernConsumeDrinkOffset);
	this->tavernFreeRoom = GetExeStringNullTerminated(exeBytes, tavernFreeRoomOffset);
	this->templeModalTitle = GetExeStringNullTerminated(exeBytes, templeModalTitleOffset);
	this->templeModalBless = GetExeStringNullTerminated(exeBytes, templeModalBlessOffset);
	this->templeModalCure = GetExeStringNullTerminated(exeBytes, templeModalCureOffset);
	this->templeModalHeal = GetExeStringNullTerminated(exeBytes, templeModalHealOffset);
	this->templeModalExit = GetExeStringNullTerminated(exeBytes, templeModalExitOffset);
	this->templeReceiveBlessing = GetExeStringNullTerminated(exeBytes, templeReceiveBlessingOffset);
	this->templeReceiveCuring = GetExeStringNullTerminated(exeBytes, templeReceiveCuringOffset);
	this->templeReceiveHealing = GetExeStringNullTerminated(exeBytes, templeReceiveHealingOffset);
	this->templePlayerIsFullHealth = GetExeStringNullTerminated(exeBytes, templePlayerIsFullHealthOffset);
	this->templeDonationAmount = GetExeStringNullTerminated(exeBytes, templeDonationAmountOffset);
	this->templePlayerIsNotDiseased = GetExeStringNullTerminated(exeBytes, templePlayerIsNotDiseasedOffset);
	this->templeServiceCost = GetExeStringNullTerminated(exeBytes, templeServiceCostOffset);
	this->citizenModalTitle = GetExeStringNullTerminated(exeBytes, citizenModalTitleOffset);
	this->citizenModalWhoAreYou = GetExeStringNullTerminated(exeBytes, citizenModalWhoAreYouOffset);
	this->citizenModalWhereIs = GetExeStringNullTerminated(exeBytes, citizenModalWhereIsOffset);
	this->citizenModalRumors = GetExeStringNullTerminated(exeBytes, citizenModalRumorsOffset);
	this->citizenModalExit = GetExeStringNullTerminated(exeBytes, citizenModalExitOffset);
	this->citizenRumorsModalTitle = GetExeStringNullTerminated(exeBytes, citizenRumorsModalTitleOffset);
