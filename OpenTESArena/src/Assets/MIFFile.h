...
public:
	...
	Span<const uint8_t> getLOOT() const;
	Span<const uint8_t> getSTOR() const;

	Span<const ArenaTypes::MIFTarget> getTARG() const;
	Span<const ArenaTypes::MIFLock> getLOCK() const;
	Span<const ArenaTypes::MIFTrigger> getTRIG() const;
};
