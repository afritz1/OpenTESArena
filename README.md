...
1. Get the Arena data files by downloading the full game from one of:
   1. [Bethesda website](https://cdnstatic.bethsoft.com/elderscrolls.com/assets/files/tes/extras/Arena106Setup.zip) (floppy disk version)
